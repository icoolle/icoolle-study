...
window.Win10 = {
    ...
    openUrl: function (url, title,areaAndOffset) {
        ...
        layero_opened.find('.layui-layer-setwin').prepend('<a class="win10-btn-change-url" index="' + index + '" title="'+Win10.lang('修改地址','Change URL')+'" href="javascript:void(0)"><span class="fa fa-chain"></span></a>' +
            '<a class="win10-btn-refresh" index="' + index + '" title="'+Win10.lang('刷新','Refresh')+'" href="javascript:void(0)"><span class="fa fa-refresh"></span></a>');
        ...
        layero_opened.find('.layui-layer-setwin .layui-layer-min').css("background-color","#ea0af9").addClass('fa fa-minus');
        layero_opened.find('.layui-layer-setwin .layui-layer-max').css("background-color","#01c701").addClass('fa fa-arrows-alt');
        layero_opened.find('.layui-layer-setwin .layui-layer-close').css("background-color","#e82d2d").addClass('fa fa-close');
