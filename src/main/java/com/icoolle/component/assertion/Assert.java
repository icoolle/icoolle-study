...
import com.icoolle.component.exception.WrapMessageException;
...
public interface Assert {
    ...
    static void assertFail(String errMsg) {
        throw new WrapMessageException(errMsg);
    }

    static void assertTrue(String errMsg, boolean b) {
        if (!b) {
            throw new WrapMessageException(errMsg);
        }
    }

    static void assertFalse(String errMsg, boolean b) {
        if (b) {
            throw new WrapMessageException(errMsg);
        }
    }
     ...
     *
     * @param obj    待判断对象
     * @param errMsg message占位符对应的参数列表
     */
    static void assertNotNull(Object obj, String errMsg) {
        if (obj == null) {
            throw new WrapMessageException(errMsg);
        }
    }
     ...
     * @param c 待判断数组
     */
    static void assertNotEmpty(Collection<?> c, String errMsg) {
        if (c == null || c.isEmpty()) {
            throw new WrapMessageException(errMsg);
        }
    }
