...
public class FileUtil extends cn.hutool.core.io.FileUtil {
     ...
     * inputStream 转 File
     */
    public static File inputStreamToFile(InputStream ins, File file, Boolean flag) throws Exception {
        if (file.exists()) {
    ...
    public static void checkSize(long maxSize, long size) {
        if (size > (maxSize * 1024 * 1024)) {
            throw new BaseException(CommonResponseEnum.SERVER_BUSY.getCode(), "文件超出规定大小");
        }
    }
